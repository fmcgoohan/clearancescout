...
- [ ] T039 [P0-Scenario-G-Ingestion-Persistence] Remediate public Scenario G ingestion persistence defect (OPEN: Local PASS vs public FAIL on 00061-lms where API reports 1 entity / 3 scenes but UI shows 0 entities; local-vs-production parity invariant; must persist and survive reload from authoritative project snapshot; completion blocked until accepted on new canary revision) (FR-030)
