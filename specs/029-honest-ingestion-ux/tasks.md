...
- [x] T039 [P0-Scenario-G-Ingestion-Persistence] Remediate public Scenario G ingestion persistence defect (VERIFIED: Both local A–K and public Cloud Run A–K 100% PASS on clearancescout-00061-lms; Coors Light 6 occurrences across 3 scenes rendered, 0 cleared / 1 insufficient evidence summary, snapshot persistence verified on reload, zero demo substitution) (FR-030)
