...
- [x] T039 [P0-Scenario-G-Ingestion-Persistence] Remediate race condition and state wipe in WorkspacePage.tsx fetchWorkspaceData and ScriptUploadModal.tsx snapshot entities passing; ensure ingested Coors Light 3-scene 6-occurrence clearance item is persisted and rendered immediately upon confirmation without flash of zero entities (FR-030)
