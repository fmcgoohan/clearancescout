...
- **FR-034**: Ergonomic Narrow-Viewport Layout & Action Reachability. On 375px viewports, header action controls, tabs, and task filtering controls MUST provide legible text, uncluttered spacing, and >=44px touch targets without clipping or reliance on horizontal page scrolling.
