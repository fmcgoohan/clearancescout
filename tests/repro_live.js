...
const LIVE_URL = 'https://clearancescout-n3tcx4jcbq-uc.a.run.app';
const DEMO_TOKEN = 'judge-pass-2026';

async function runLiveVerification() {
  console.log('=== LIVE PLAYWRIGHT VERIFICATION AUDIT ===');
  ...
  try {
    ...
    console.log('[Step 1] Navigating to live target URL...');
